...
# 2. Day4 klasörüne gidin
cd ai-datascience-bootcamp2026/day4
...
### 🔄 **Hata Yapın**
KeyError, TypeError hatalarını görmek öğrenmenin bir parçası. Her veri yapısının sınırlarını test edin ve öğrenin.
...
### 🤝 **Gerçek Veri Kullanın**
Fitness takibi, ülke analitiği gibi gerçek senaryolar kullanın. Kendi verilerinizle pratik yapın.
...
### ✨ Görsel Tasarım
- Ultra-modern gradient renk şemaları ve profesyonel layout
- Emoji destekli navigasyon ve bölüm başlıkları
- Renkli tablo ve grid düzenler
- Veri yapılarına özel kod vurguları
- Responsive ve temiz, göz yormayan arayüz

### 🎯 İnteraktif İçerik
- Her veri yapısı için çalıştırılabilir örnekler
- Gerçek senaryolar ile pratik yapma imkanı
- Fitness, ülke, koordinat senaryolarından canlı örnekler
- Adım adım debug ve detaylı açıklama
- Try-it-yourself kod blokları ve egzersizler

### 💻 Kod Organizasyonu
- Her satır detaylı Türkçe yorum ile açıklanmış
- Print statement'lar ile adım adım takip
- Anlaşılır ve tutarlı değişken isimlendirmesi
- Best practices ve clean code prensipleri
- PEP 8 standartlarına uygun kod yazımı

### 🔄 Progressive Learning
- List → Dictionary → Set → Tuple → Boolean progresyonu
- Her konsept bir öncekine bağlı ve mantıklı sıra
- Spiral öğrenme yaklaşımı ile pekiştirme
- Gerçek dünya örnekleri ile kalıcı öğrenme
...
### KeyError: 'key_name'
```python
# Dictionary'de olmayan bir key'e erişmeye çalıştığınızda
my_dict = {"apple": 100}
# print(my_dict["banana"])  # ❌ KeyError!

# ✅ Çözüm 1: get() metodunu kullanın
print(my_dict.get("banana"))  # None döner, hata vermez
print(my_dict.get("banana", 0))  # Default değer verebilirsiniz

# ✅ Çözüm 2: Önce kontrol edin
...
# ✅ Çözüm 1: List'e çevirin
my_list = list(my_set)
print(my_list[0])

# ✅ Çözüm 2: Loop kullanın
for item in my_set:
    print(item)
...
```python
# Boş süslü parantez dictionary oluşturur!
empty = {}
print(type(empty))  # <class 'dict'> ⚠️

# ✅ Boş set için set() kullanın
empty_set = set()
print(type(empty_set))  # <class 'set'> ✅
```

### Dictionary'de birden fazla aynı key
```python
# Aynı key'i tekrar kullanırsanız, son değer geçerli olur
my_dict = {"apple": 100, "apple": 150}
print(my_dict)  # {'apple': 150} ⚠️

# ✅ Çözüm: Unique key'ler kullanın
...
<td>Tüm anahtarları döndürür</td>
<td><code>d.keys()</code></td>
<td><code>dict_keys(['a', 'b'])</code></td>
</tr>
<tr>
<td><code>values()</code></td>
<td>Tüm değerleri döndürür</td>
...
### 🌟 Profesyoneller İçin İleri Teknikler
...
- ✨ Yeni Dictionary/Set/Tuple örnekleri ekleyin
- 📝 Dokümantasyonu geliştirin
- 🌍 Çeviri yapın
- 💡 Önerilerinizi paylaşın
- 🎯 Yeni gerçek dünya senaryoları ekleyin

**Katkıda bulunmak için:**
1. Fork edin
2. Feature branch oluşturun (`git checkout -b feature/amazing-data-structure`)
3. Commit edin (`git commit -m 'feat: Add amazing dictionary example'`)
4. Push edin (`git push origin feature/amazing-data-structure`)
5. Pull Request açın
...
**Mutlu Kodlamalar ve Başarılı Data Structure Mastery!**
...
### 🎯 **"Doğru veri yapısı seçimi, kodunuzun performansını belirler"**
...
- 💡 [W3Schools - Python Data Structures](https://www.w3schools.com/python/python_ref_dictionary.asp)
- 🔍 [Stack Overflow - Python Dictionary](https://stackoverflow.com/questions/tagged/python-dictionary)
- 📺 [YouTube - Python Data Structures Tutorial](https://www.youtube.com/results?search_query=python+data+structures)
